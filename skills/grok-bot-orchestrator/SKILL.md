...
Companion docs: [docs/grok-bot.md](../../docs/grok-bot.md), [docs/architecture.md](../../docs/architecture.md).
...
- Cursor's `mcp.json` / this plugin's stdio server **does not automatically appear** on Grok Bot. Re-add the connector there.
...
3. **Import skills** from [this repo](https://github.com/MindDragonLabs/grok-openllm-orchestrator) (`skills/*/SKILL.md`) or paste the prose into Grok Bot skills. Minimum set: `getting-started`, `openllm-connect`, `openllm-dashboard`, `openllm-dev-task`, `grok-bot-orchestrator`.
